...
// Always set product ID for the container
...
echo '<div class="wcpr-shopee-reviews-container" data-product-id="' . esc_attr( $product_id ) . '">';
...
if ($count_reviews > 0) {
	...
	<div class="wcpr-shopee-overall-rating">
		<div class="wcpr-shopee-rating-summary">
			...
			<div class="wcpr-shopee-rating-filters" role="group" aria-label="<?php esc_attr_e( 'Review filters', 'woocommerce-photo-reviews' ); ?>">
				<button type="button" class="wcpr-shopee-filter-button wcpr-active" data-filter="all"><?php esc_html_e( 'All Reviews', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="5"><?php esc_html_e( '5 Stars', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="4"><?php esc_html_e( '4 Stars', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="3"><?php esc_html_e( '3 Stars', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="2"><?php esc_html_e( '2 Stars', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="1"><?php esc_html_e( '1 Star', 'woocommerce-photo-reviews' ); ?></button>
				<button type="button" class="wcpr-shopee-filter-button" data-filter="media"><?php esc_html_e( 'With Media', 'woocommerce-photo-reviews' ); ?></button>
			</div>
...
// Reviews list wrapper for AJAX updates
echo '<div class="wcpr-shopee-reviews-list">';
...
echo '</div>'; // .wcpr-shopee-reviews-list
