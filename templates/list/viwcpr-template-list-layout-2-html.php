                    ...
                    <div class="<?php echo esc_attr($prefix_class); ?>review-content-image">
                        ...
                        if (is_array($img_post_ids) && !empty($img_post_ids)) {
                            ...
                            <div class="<?php echo esc_attr($prefix_class); ?>reviews-images-container">
                                ...
                                <?php
                                $clones = $img_post_ids;
                                /*Show qty image if count image more than 3*/
                                if (count($img_post_ids) > 3) {
                                    ?>
                                    <div class="<?php echo esc_attr($prefix_class); ?>images-qty">+<?php echo esc_html(count($img_post_ids) - 3); ?></div>
                                    <?php
                                }
                                ?>
                            </div>
