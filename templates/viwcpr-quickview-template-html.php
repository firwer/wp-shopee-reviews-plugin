...
<div class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-light-box">
    <div class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-light-box-wrapper">
        ...
        <div class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-wrap-container">
            ...
            <div id="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-wrap"
                 class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-wrap">
                <div id="<?php echo esc_attr( $prefix_class ); ?>reviews-content-left"
                     class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-content">
                ...
                <div id="<?php echo esc_attr( $prefix_class ); ?>reviews-content-right"
                     class="<?php echo esc_attr( $prefix_class ); ?>wcpr-modal-content">
